...
from keras_yolo_b_2.yolo3.utils import letterbox_image
from keras_yolo_b_2.yolo3.model import yolo_eval, yolo_body, tiny_yolo_body
from keras.layers import Input


class License_plate_Detector_b_2:
    def __init__(self, model_num=20000, image_input_size=416, score_value=0.1):
        self.yolo_model = None
        self.model_path = 'weights/weights_b_2/yolov3_' + str(model_num) + '_weights.h5'
        self.anchors_path = 'keras_yolo_b_2/model_data/yolo_anchors.txt'
        self.classes_path = 'keras_yolo_b_2/model_data/coco_classes.txt'
