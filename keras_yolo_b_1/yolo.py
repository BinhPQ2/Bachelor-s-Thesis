...
from keras_yolo_b_1.yolo3.utils import letterbox_image
from keras_yolo_b_1.yolo3.model import yolo_eval, yolo_body, tiny_yolo_body
from keras.layers import Input


class License_plate_Detector_b_1:
    def __init__(self, model_num=27500, image_input_size=512, score_value=0.3):
        self.yolo_model = None
        self.model_path = 'weights/weights_b_1/yolov3_' + str(model_num) + '_weights.h5'
        self.anchors_path = 'keras_yolo_b_1/model_data/yolo_anchors.txt'
        self.classes_path = 'keras_yolo_b_1/model_data/coco_classes.txt'
    ...
    def detect_image(self, image):
        ...
        dict_results = {}  # tao ra 1 dict rong de chua cac toa do cac box
